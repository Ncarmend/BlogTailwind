...
const Contact = ()=> {
  return (
    <div className="block max-w-xl  mx-96 rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] light:bg-neutral-700">
      <form>
        {/* <!--Name input--> */}
        <TEInput
          type="text"
